...
import aepherasadditions.content.custom.planets.CynerisPlanetGenerator;
import aepherasadditions.content.custom.planets.MercuryPlanetGenerator;
import aepherasadditions.content.custom.planets.ProximaCPlanetGenerator;
import aepherasadditions.content.custom.mesh.RingMesh;
    ...
    public static void load() throws IOException {
        cyneris = new Planet("cyneris", Planets.sun, 1f, 1){{
            ...
            ruleSetter = r -> {
                ...
                r.bannedBlocks.addAll(ABlocks.serpuloBlocks);
                r.bannedBlocks.addAll(ABlocks.erekirBlocks);
                r.fog = false;
                r.cleanupDeadTeams = true;
                r.coreIncinerates = true;
                r.planet = APlanets.cyneris;
            ...
            defaultCore = ABlocks.coreEcho;
            hiddenItems.addAll(AItems.serpuloItemsKey);
            hiddenItems.addAll(AItems.erekirItemsKey);
            hiddenItems.removeAll(AItems.cynerisItemsKey);
            itemWhitelist = AItems.cynerisItemsKey;
        ...
        Planets.serpulo.hiddenItems.addAll(AItems.cynerisItemsKey);
        Planets.erekir.hiddenItems.addAll(AItems.cynerisItemsKey);
    }
