...
public class MercuryPlanetGenerator extends PlanetGenerator {
    float scl = 5.0F;
    float iceOffset = 0.07F;

    Block[][] arr = {
            {Blocks.stone, Blocks.stone, Blocks.stone, Blocks.metalFloor4, Blocks.metalFloor4, Blocks.basalt},
            {Blocks.stone, Blocks.basalt, Blocks.metalFloor4, Blocks.metalFloor4, Blocks.basalt, Blocks.basalt},
            {Blocks.metalFloor4, Blocks.metalFloor4, Blocks.basalt, Blocks.basalt, Blocks.stone, Blocks.stone},
            {Blocks.stone, Blocks.stone, Blocks.metalFloor4, Blocks.metalFloor4, Blocks.basalt, Blocks.basalt}
    };
    ...
    public Color getColor(Vec3 position) {
        ...
        return block == Blocks.stone ? Blocks.metalFloor.mapColor : Tmp.c1.set(block.mapColor).a(1.0F - block.albedo);
    }
