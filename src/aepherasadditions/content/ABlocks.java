...
import aepherasadditions.content.custom.block.CrystalBlock;
import aepherasadditions.content.custom.block.CynerisPowerNode;
import aepherasadditions.content.custom.block.ModuleFactory;
import aepherasadditions.content.custom.block.TallMushroom;
import aepherasadditions.content.custom.drawer.DrawGrapheneWeave;
import aepherasadditions.content.custom.drawer.DrawVenusPlasma;
...
public class ABlocks {
    ...
    public static Block
            ...
            //power - Cyneris
            linkNode, linkNodeLarge, burnerGenerator, burner, burnerLarge, steamTurbine, steamTurbineLarge, steamTurbineHuge, steamTurbineGigantic,

            //production
            impulseDrill, hydrator, mycoformer,

            //production - Cyneris
            mechanicalExtractor, impulseExtractor, surgeExtractor, surgeExtractorLarge, carbonScrubber, carbonConcentrator, atmosphericExtractor, aqueousExtractor, hydricExtractor, OsmoticExtractor,
            ...
            //turrets - Cyneris
            bract, gale, reign, ataraxia, testTurret, citadel,

            //units
            repairSpire, imperiumSynthesizer, stellarSynthesizer, venomSynthesizer, solarisSynthesizer, modulusSynthesizer, tidebreakerSynthesizer, nereidSynthesizer, basicSynthesisModule, advancedSynthesisModule, basicArmorModule, calibratedArmorModule, integratedArmorModule, maximizedArmorModule, basicAssaultModule, calibratedAssaultModule, integratedAssaultModule, maximizedAssaultModule, basicSupportModule, calibratedSupportModule, integratedSupportModule, maximizedSupportModule, basicSpecialtyModule, calibratedSpecialtyModule, integratedSpecialtyModule, maximizedSpecialtyModule, basicModuleConstructor, advancedModuleConstructor, integratedModuleConstructor, maximizedModuleConstructor,
    ...
    public static void load(){
        ...
        oreAluminum = new OreBlock("ore-aluminum", AItems.aluminum);
        oreFerrite = new OreBlock("ore-ferrite", AItems.ferrite);
        oreCobalt = new OreBlock("ore-cobalt", AItems.cobalt);
        oreChromium = new OreBlock("ore-chromium", AItems.chromium);
        oreSulfur = new OreBlock("ore-sulfur", AItems.sulfur);
        oreVanadium = new OreBlock("ore-vanadium", AItems.vanadium);
        ...
        rubyFloor = new Floor("ruby-floor"){{
            ...
            lightRadius = 25f;
            cacheLayer = ACacheLayers.crystal;
        }};
        ...
        cauradine = new Floor("cauradine"){{
            ...
            isLiquid = true;
            cacheLayer = ACacheLayers.cauradine;
        ...
        cauricStone = new Floor("cauric-stone"){{
            ...
            lightRadius = 25f;
            cacheLayer = ACacheLayers.crystalDark;
        }};
        ...
        cokingOven = new GenericCrafter("coking-oven"){{
            ...
            outputItem = new ItemStack(AItems.coalCoke, 1);
        }};
        ...
        cokingBlaster = new AttributeCrafter("coking-blaster"){{
            ...
            outputItem = new ItemStack(AItems.coalCoke, 4);
        }};
        ...
        voltaliteMixer = new GenericCrafter("voltalite-mixer"){{
            ...
            outputItem = new ItemStack(AItems.voltalite, 1);
        }};
        ...
        voltaliteCatalyzer = new GenericCrafter("voltalite-catalyzer"){{
            ...
            outputItem = new ItemStack(AItems.voltalite, 6);
        }};
        ...
        nuclearMixer = new GenericCrafter("nuclear-mixer"){{
            ...
            consumePower(1.6f);
            consumeItems(with(AItems.voltalite, 1, Items.thorium, 3));

            outputItem = new ItemStack(AItems.nuclearCompound, 1);
        }};
        ...
        nuclearCatalyzer = new GenericCrafter("nuclear-catalyzer"){{
            ...
            consumePower(6f);
            consumeItems(with(AItems.voltalite, 6, Items.thorium, 12));
            consumeLiquid(Liquids.water, 0.2f);

            outputItem = new ItemStack(AItems.nuclearCompound, 6);
        }};
        ...
        titanSmelter = new GenericCrafter("titan-smelter"){{
            ...
            consumePower(3f);
            consumeItems(with(Items.titanium, 2, AItems.coalCoke, 2));

            outputItem = new ItemStack(AItems.titansteel, 2);
        }};
        ...
        titanCrucible = new AttributeCrafter("titan-crucible"){{
            ...
            consumePower(4f);
            consumeItems(with(Items.titanium, 6, AItems.coalCoke, 4, Items.pyratite, 1));

            outputItem = new ItemStack(AItems.titansteel, 8);
        }};

        //crafting - Cyneris

        carbyteCondensor = new GenericCrafter("carbyte-condensor"){{
            requirements(Category.crafting, with(AItems.aluminum, 30, AItems.ferrite, 25));
            size = 2;
            hasItems = hasPower = hasLiquids = true;
            itemCapacity = 10;
            craftTime = 80;
            ...
            consumePower(0.5f);
            consumeLiquid(ALiquids.carbonDioxide, 0.6f);

            outputItem = new ItemStack(AItems.carybte, 2);
        ...
        sapphireCrystallizer = new GenericCrafter("sapphire-crystallizer"){{
            requirements(Category.crafting, with(AItems.aluminum, 90, AItems.ferrite, 75));
            size = 3;
            hasItems = hasPower = hasLiquids = true;
            itemCapacity = 10;
            craftTime = 30f;
            ...
            consumePower(0.5f);
            consumeItems(with(AItems.aluminum, 1, AItems.ferrite, 1));
            consumeLiquid(Liquids.water, 0.2f);

            outputItem = new ItemStack(AItems.sapphire, 1);
        }};

        grapheneSynthesizer = new GenericCrafter("graphene-synthesizer"){{
            requirements(Category.crafting, with(AItems.aluminum, 40, AItems.ferrite, 30));
            size = 2;
            hasItems = hasPower = true;
            itemCapacity = 10;
            craftTime = 40f;
            ...
            consumePower(1f);
            consumeItem(AItems.carybte, 2);

            outputItem = new ItemStack(AItems.graphene, 1);
        }};
        ...
        titansteelWall = new Wall("titansteel-wall"){{
            requirements(Category.defense, with(AItems.titansteel, 12, Items.surgeAlloy, 12, Items.plastanium, 10, Items.metaglass, 4, Items.phaseFabric, 12));
            size = 1;
            scaledHealth = 1024f;
        ...
        titansteelWallLarge = new Wall("titansteel-wall-large"){{
            requirements(Category.defense, with(AItems.titansteel, 48, Items.surgeAlloy, 48, Items.plastanium, 40, Items.metaglass, 16, Items.phaseFabric, 48));
            size = 2;
            scaledHealth = 1024f;
            insulated = absorbLasers = flashHit = true;
            chanceDeflect = 10f;
        ...
        titansteelWallHuge = new Wall("titansteel-wall-huge"){{
            requirements(Category.defense, with(AItems.titansteel, 108, Items.surgeAlloy, 108, Items.plastanium, 90, Items.metaglass, 36, Items.phaseFabric, 108));
            size = 3;
            scaledHealth = 1024f;
            insulated = absorbLasers = flashHit = true;
            chanceDeflect = 10f;
        ...
        titansteelWallGigantic = new Wall("titansteel-wall-gigantic"){{
            requirements(Category.defense, with(AItems.titansteel, 192, Items.surgeAlloy, 192, Items.plastanium, 160, Items.metaglass, 64, Items.phaseFabric, 192));
            size = 4;
            scaledHealth = 1024f;
            insulated = absorbLasers = flashHit = true;
            chanceDeflect = 10f;
        ...
        titansteelConveyor = new StackConveyor("titansteel-conveyor"){{
            requirements(Category.distribution, with(AItems.titansteel, 2, Items.plastanium, 2, Items.thorium, 2));
            health = 345;
            speed = 0.1f;
            itemCapacity = 25;
        }};
        ...
        pulseDriver = new MassDriver("pulse-driver"){{
            requirements(Category.distribution, with(AItems.aluminum, 10));
            size = 1;
            range = 80f;
            itemCapacity = 15;
            researchCostMultiplier = 0.11f;
        ...
        strataDriver = new MassDriver("strata-driver"){{
            requirements(Category.distribution, with(AItems.aluminum, 50, AItems.ferrite, 40, AItems.graphene, 30));
            size = 2;
            range = 200f;
            itemCapacity = 50;
            consumePower(1/3f);
        ...
        primeDriver = new MassDriver("prime-driver"){{
            requirements(Category.distribution, with( AItems.ferrite, 130, AItems.graphene, 80, AItems.steel, 55));
            size = 3;
            range = 500f;
            itemCapacity = 125;
            consumePower(1f);
        ...
        insulatedConduit = new Conduit("insulated-conduit"){{
            requirements(Category.liquid, with(AItems.sapphire, 1, AItems.aluminum, 1));
            size = 1;
            liquidCapacity = 20f;
            health = 65;
        }};
        ...
        primeConduit = new Conduit("prime-conduit"){{
            requirements(Category.liquid, with(AItems.sapphire, 1, AItems.cobalt, 2));
            size = 1;
            liquidCapacity = 40f;
        ...
        shieldedConduit = new ArmoredConduit("shielded-conduit"){{
            requirements(Category.liquid, with(AItems.steel, 2, AItems.sapphire, 1, AItems.chromium, 1));
            size = 1;
            liquidCapacity = 50f;
        ...
        insulatedLiquidRouter = new LiquidRouter("insulated-liquid-router"){{
            requirements(Category.liquid, with(AItems.sapphire, 2, AItems.ferrite, 4));
            size = 1;
            liquidCapacity = 120f;
            underBullets = true;
            solid = false;
        ...
        liquidCapsule = new LiquidRouter("liquid-capsule"){{
            requirements(Category.liquid, with(AItems.sapphire, 15, AItems.cobalt, 10));
            size = 2;
            liquidCapacity = 700f;
            solid = true;
        }};
        ...
        liquidCell = new LiquidRouter("liquid-cell"){{
            requirements(Category.liquid, with(AItems.sapphire, 40, AItems.cobalt, 30));
            size = 3;
            liquidCapacity = 1800;
            solid = true;
        }};
        ...
        liquidReservoir = new LiquidRouter("liquid-reservoir"){{
            requirements(Category.liquid, with(AItems.sapphire, 75, AItems.cobalt, 50));
            size = 4;
            liquidCapacity = 5500;
            solid = true;
        }};
        ...
        voltaliteReactor = new ImpactReactor("voltalite-reactor"){{
            ...
            consumePower(60f);
            consumeItems(with(AItems.voltalite, 5, Items.thorium, 5, Items.blastCompound, 5));
            consumeLiquid(Liquids.cryofluid, 1.6f);
            explodeEffect = AFx.voltaliteReactorExplosion;
        }};
        ...
        nuclearReactor = new ImpactReactor("nuclear-reactor"){{
            ...
            consumePower(130f);
            consumeItems(with(AItems.nuclearCompound, 5, Items.graphite, 1, Items.titanium, 1));
            consumeLiquid(Liquids.cryofluid, 2.4f);
            explodeEffect = AFx.nuclearReactorExplosion;
        }};
        ...
        venusReactor = new ImpactReactor("venus-reactor"){{
            ...
            consumePower(676f);
            consumeItems(with(AItems.nuclearCompound, 5, AItems.voltalite, 10, Items.blastCompound, 15));
            consumeLiquid(Liquids.cryofluid, 3.2f);
            explodeEffect = new MultiEffect(AFx.venusReactorExplosion1, AFx.venusReactorExplosion2, Fx.bigShockwave, Fx.scatheExplosion, Fx.sparkExplosion, Fx.explosion, Fx.titanExplosion);
        }};

        linkNode = new CynerisPowerNode("link-node", Color.valueOf("4c7ee7")){{
            requirements(Category.power, with(AItems.aluminum, 2, AItems.ferrite, 2));
            maxNodes = 10;
            laserRange = 6f;
        ...
        mechanicalExtractor = new BurstDrill("mechanical-extractor"){{
            requirements(Category.production, with(AItems.aluminum, 15));
            drillTime = 600f;
            arrows = 2;
            size = 2;
            tier = 2;
            ...
            baseArrowColor = Color.valueOf("4a4b53");
        ...
        carbonScrubber = new GenericCrafter("carbon-scrubber"){{
            requirements(Category.production, with(AItems.aluminum, 30, AItems.ferrite, 40));
            size = 2;
            hasLiquids = true;
            liquidCapacity = 24f;
            ...
            consumePower(0.5f);
            outputLiquid = new LiquidStack(ALiquids.carbonDioxide, 0.1f);
        }};

        atmosphericExtractor = new GenericCrafter("atmospheric-extractor"){{
            requirements(Category.production, with(AItems.ferrite, 70, AItems.graphene, 80, AItems.cobalt, 50));
            size = 3;
        ...
        coreApex = new CoreBlock("core-apex"){{
            ...
            researchCostMultiplier = 0.11f;
            itemCapacity = 18000;
            unitType = AUnitTypes.delta;
        }};

        receptacle = new StorageBlock("receptacle"){{
            requirements(Category.effect, with(Items.titanium, 500, Items.thorium, 250, AItems.titansteel, 125));
            scaledHealth = 55f;
            itemCapacity = 3000;
            size = 5;
        }};
        ...
        coreEcho = new CoreBlock("core-echo"){{
            requirements(Category.effect, BuildVisibility.editorOnly, with(AItems.aluminum, 1000, AItems.ferrite, 1000));
            health = 1000;
            size = 2;
            alwaysUnlocked = isFirstTier = true;
            unitCapModifier = 8;
            itemCapacity = 5000;
            unitType = AUnitTypes.drift;
        }};

        coreCodex = new CoreBlock("core-codex"){{
            requirements(Category.effect, BuildVisibility.shown, with(AItems.aluminum, 4000, AItems.ferrite, 4000, AItems.graphene, 3000));
            health = 3000;
            size = 3;
            unitCapModifier = 16;
            itemCapacity = 10000;
            researchCostMultiplier = 0.11f;
            unitType = AUnitTypes.veil;
        }};

        coreAnima = new CoreBlock("core-anima"){{
            requirements(Category.effect, BuildVisibility.shown, with(AItems.aluminum, 9000, AItems.ferrite, 9000, AItems.steel, 5000, AItems.graphene, 6000));
            health = 5000;
            size = 4;
            unitCapModifier = 24;
            itemCapacity = 15000;
            researchCostMultiplier = 0.11f;
            unitType = AUnitTypes.tempest;
        }};

        capsule = new StorageBlock("capsule"){{
            requirements(Category.effect, with(AItems.aluminum, 10));
            scaledHealth = 55f;
            itemCapacity = 25;
            size = 1;
        }};
        ...
        disrupt = new ItemTurret("disrupt"){{
            ...
            ammo(
                    ...
                    AItems.voltalite, new ArtilleryBulletType(3f, 20){{
                        lifetime = 100f;
                        width = height = 16f;
                        collidesTiles = false;
                        splashDamage = 85f;
                    ...
                    AItems.nuclearCompound, new ArtilleryBulletType(3f, 30){{
                        lifetime = 100f;
                        width = height = 16f;
                        collidesTiles = false;
                        splashDamage = 110f;
        ...
        hive = new ItemTurret("hive"){{
            ...
            ammo(
                    ...
                    AItems.voltalite, new ArtilleryBulletType(3f, 25){{
                        lifetime = 50f;
                        width = height = 15f;
                        collidesGround = collidesTiles = false;
                        fragBullets = 3;
        ...
        bract = new ItemTurret("bract"){{
            requirements(Category.turret, with(AItems.aluminum, 30, AItems.ferrite, 10));
            ammo(
                    AItems.aluminum, new BasicBulletType(2.5f, 9){{
                        width = 7f;
                        height = 9f;
                        lifetime = 60f;
                        ammoMultiplier = 2;
                        hitEffect = despawnEffect = Fx.hitBulletColor;
                        frontColor = APal.aluminumAmmoFront;
                        backColor = APal.aluminumAmmoBack;
                    }},
                    AItems.ferrite, new BasicBulletType(2f, 9){{
                        width = 7f;
                        height = 9f;
                        lifetime = 75f;
                        ammoMultiplier = 2;
                        hitEffect = despawnEffect = Fx.hitBulletColor;
                        frontColor = APal.ferriteAmmoFront;
                        backColor = APal.ferriteAmmoBack;
                    }},
                    AItems.vanadium, new BasicBulletType(3f, 15){{
                        width = 7f;
                        height = 9f;
                        lifetime = 50f;
                        ammoMultiplier = 1;
                        hitEffect = despawnEffect = Fx.hitBulletColor;
                        frontColor = APal.vanadiumAmmoFront;
                        backColor = APal.vanadiumAmmoBack;
                    }},
                    AItems.graphene, new BasicBulletType(2.5f, 9){{
                        width = 6f;
                        height = 8f;
                        lifetime = 60f;
                        ammoMultiplier = 4;
                        ...
                        hitEffect = despawnEffect = Fx.hitBulletColor;
                        frontColor = APal.grapheneAmmoFront;
                        backColor = APal.grapheneAmmoBack;
                        homingPower = 0.08f;
                        homingRange = 50f;
                    }}
            );
        ...
        gale = new ItemTurret("gale"){{
            requirements(Category.turret, with(AItems.aluminum, 75, AItems.ferrite, 60));
            ammo(
                    AItems.ferrite, new FlakBulletType(5f, 2){{
                        lifetime = 48f;
                        ammoMultiplier = 3f;
                    ...
                    AItems.vanadium, new FlakBulletType(6f, 3){{
                        lifetime = 40f;
                        ammoMultiplier = 3f;
                        shootEffect = Fx.shootSmall;
                        width = 5f;
                    ...
                    AItems.sapphire, new FlakBulletType(5f, 5){{
                        lifetime = 48f;
                        ammoMultiplier = 5f;
                        shootEffect = Fx.shootSmall;
                        width = 6.5f;
                        ...
                        frontColor = APal.sapphireAmmoFront;
                        backColor = APal.sapphireAmmoBack;
                        despawnEffect = Fx.hitBulletColor;
                        ...
                        fragBullet = new BasicBulletType(3f, 1){{
                            ...
                            shrinkY = 1f;
                            lifetime = 20f;
                            backColor = trailColor = APal.sapphireAmmoBack;
                            hitColor = frontColor = APal.sapphireAmmoFront;
                            despawnEffect = Fx.none;
        ...
        testTurret = new ItemTurret("test-turret"){{
            ...
            range = 300f;
            ammo(
                    Items.copper, new ArtilleryBulletType(5.0f, 3.0f){{
                        lifetime = 60f;
                        fragBullets = 10;
                        width = height = 15f;
                        fragBullet = new BulletType(){{
                            ...
                            spawnUnit = new MissileUnitType("test-missile"){{
                                speed = 3f;
                                maxRange = 3f;
                                health = 25f;
                                lowAltitude = true;
                                ...
                                weapons.add(new Weapon(){{
                                    ...
                                    bullet = new ExplosionBulletType(25f, 20){{
                                        ...
                                        fragBullets = 5;
                                        fragBullet = new ArtilleryBulletType(5.0f, 5.0f){{
                                            lightning = 5;
                                            lightningLength = 25;
                                            lightningDamage = 20;
                                            width = height = 15f;
        ...
        citadel = new ItemTurret("citadel"){{
            requirements(Category.turret, with(AItems.aluminum, 100));
            ammo(
                    Items.copper, new BulletType(0f, 0f){{
                        keepVelocity = false;
                        speed = 0;
                        ...
                        spawnUnit = new MissileUnitType("citadel-missile"){{
                            speed = 3f;
                            lifetime = 7200f;
                            maxRange = 10f;
                            health = 1500f;
                            ...
                            weapons.add(new Weapon(){{
                                ...
                                reload = 1f;
                                shootOnDeath = true;
                                bullet = new ExplosionBulletType(25000f, 200){{
                                    collidesAir = true;
                                    shootEffect = new ExplosionEffect(){{
                                        lifetime = 50f;
                                        waveStroke = 50f;
                                        waveLife = 80f;
                                        waveColor = Color.white;
                                        sparkColor = smokeColor = Pal.techBlue;
                                        waveRad = 150f;
                                        smokeSize = 30f;
                                        smokes = 15;
                                        smokeSizeBase = 0f;
        ...
        basicSynthesisModule = new UnitAssemblerModule("basic-synthesis-module"){{
            requirements(Category.units, with(Items.lead, 300, Items.titanium, 300, Items.silicon, 200, Items.thorium, 100));
            researchCostMultiplier = 0.5f;
            size = 5;
            tier = 1;
        }};

        advancedSynthesisModule = new UnitAssemblerModule("advanced-synthesis-module"){{
            requirements(Category.units, with(Items.lead, 550, Items.titanium, 550, Items.silicon, 300, Items.thorium, 250, Items.plastanium, 200, Items.phaseFabric, 100));
            researchCostMultiplier = 0.5f;
            size = 7;
            tier = 2;
        }};

        basicArmorModule = new Wall("basic-armor-module"){{
            requirements(Category.units, with(Items.silicon, 650, Items.lead, 750, Items.plastanium, 450, Items.titanium, 550));
            size = 2;
            scaledHealth = 25;
        }};

        basicAssaultModule = new Wall("basic-assault-module"){{
            requirements(Category.units, with(Items.silicon, 650, Items.lead, 750, Items.plastanium, 450, Items.thorium, 450));
            size = 2;
            scaledHealth = 25;
        }};

        basicSupportModule = new Wall("basic-support-module"){{
            requirements(Category.units, with(Items.silicon, 850, Items.lead, 750, Items.plastanium, 450, Items.phaseFabric, 150));
            size = 2;
            scaledHealth = 25;
        }};

        basicSpecialtyModule = new Wall("basic-specialty-module"){{
            requirements(Category.units, with(Items.silicon, 650, Items.lead, 750, Items.plastanium, 450, Items.surgeAlloy, 350));
            size = 2;
            scaledHealth = 25;
        }};

        calibratedArmorModule = new Wall("calibrated-armor-module"){{
            requirements(Category.units, with(Items.silicon, 850, Items.lead, 950, Items.plastanium, 650, Items.titanium, 750));
            size = 2;
            scaledHealth = 25;
        }};

        calibratedAssaultModule = new Wall("calibrated-assault-module"){{
            requirements(Category.units, with(Items.silicon, 850, Items.lead, 950, Items.plastanium, 650, Items.thorium, 650));
            size = 2;
            scaledHealth = 25;
        }};

        calibratedSupportModule = new Wall("calibrated-support-module"){{
            requirements(Category.units, with(Items.silicon, 1050, Items.lead, 950, Items.plastanium, 650, Items.phaseFabric, 350));
            size = 2;
            scaledHealth = 25;
        }};

        calibratedSpecialtyModule = new Wall("calibrated-specialty-module"){{
            requirements(Category.units, with(Items.silicon, 850, Items.lead, 950, Items.plastanium, 650, Items.surgeAlloy, 550));
            size = 2;
            scaledHealth = 25;
        }};

        integratedArmorModule = new Wall("integrated-armor-module"){{
            requirements(Category.units, with(Items.silicon, 1150, Items.lead, 1250, Items.plastanium, 950, Items.titanium, 1050, Items.surgeAlloy, 600));
            size = 4;
            scaledHealth = 25;
        }};

        integratedAssaultModule = new Wall("integrated-assault-module"){{
            requirements(Category.units, with(Items.silicon, 1150, Items.lead, 1250, Items.plastanium, 950, Items.thorium, 950, Items.surgeAlloy, 600));
            size = 4;
            scaledHealth = 25;
        }};

        integratedSupportModule = new Wall("integrated-support-module"){{
            requirements(Category.units, with(Items.silicon, 1350, Items.lead, 1250, Items.plastanium, 950, Items.phaseFabric, 550, Items.surgeAlloy, 600));
            size = 4;
            scaledHealth = 25;
        }};

        integratedSpecialtyModule = new Wall("integrated-specialty-module"){{
            requirements(Category.units, with(Items.silicon, 1150, Items.lead, 1250, Items.plastanium, 950, Items.surgeAlloy, 750, Items.surgeAlloy, 600));
            size = 4;
            scaledHealth = 25;
        }};

        maximizedArmorModule = new Wall("maximized-armor-module"){{
            requirements(Category.units, with(Items.silicon, 1650, Items.lead, 1750, Items.plastanium, 1450, Items.titanium, 1550, Items.surgeAlloy, 1300));
            size = 4;
            scaledHealth = 25;
        }};

        maximizedAssaultModule = new Wall("maximized-assault-module"){{
            requirements(Category.units, with(Items.silicon, 1650, Items.lead, 1750, Items.plastanium, 1450, Items.thorium, 1450, Items.surgeAlloy, 1300));
            size = 4;
            scaledHealth = 25;
        }};

        maximizedSupportModule = new Wall("maximized-support-module"){{
            requirements(Category.units, with(Items.silicon, 1850, Items.lead, 1750, Items.plastanium, 1450, Items.phaseFabric, 1150, Items.surgeAlloy, 1300));
            size = 4;
            scaledHealth = 25;
        }};

        maximizedSpecialtyModule = new Wall("maximized-specialty-module"){{
            requirements(Category.units, with(Items.silicon, 1650, Items.lead, 1750, Items.plastanium, 1450, Items.surgeAlloy, 1350, Items.surgeAlloy, 1300));
            size = 4;
            scaledHealth = 25;
        }};

        basicModuleConstructor = new ModuleFactory("basic-module-constructor"){{
        ...
        advancedModuleConstructor = new ModuleFactory("advanced-module-constructor"){{
            requirements(Category.units, with(Items.lead, 650, Items.titanium, 350, Items.thorium, 650, Items.silicon, 450));
            researchCostMultiplier = 0.75f;
            size = 5;
            moduleSize = 4;
        }};

        imperiumSynthesizer = new UnitAssembler("imperium-synthesizer"){{
            requirements(Category.units, with(Items.lead, 3000, Items.titanium, 3000, Items.thorium, 1200, Items.silicon, 1200, Items.plastanium, 750, Items.phaseFabric, 1000, Items.surgeAlloy, 1500));
            size = 9;
            plans.add(
                    new AssemblerUnitPlan(AUnitTypes.regent, 3600f, PayloadStack.list(UnitTypes.scepter, 4, ABlocks.basicArmorModule, 7, ABlocks.basicAssaultModule, 4)),
                    new AssemblerUnitPlan(AUnitTypes.sovereign, 10800f, PayloadStack.list(UnitTypes.reign, 6, ABlocks.calibratedArmorModule, 9, ABlocks.calibratedAssaultModule, 6))
            );
            areaSize = 13;
            droneType = AUnitTypes.synthesisDrone;

            consumePower(15f);
            consumeLiquid(Liquids.cryofluid, 0.8f);
        }};

        stellarSynthesizer = new UnitAssembler("stellar-synthesizer"){{
            requirements(Category.units, with(Items.lead, 3000, Items.titanium, 3000, Items.thorium, 1200, Items.silicon, 1200, Items.plastanium, 750, Items.phaseFabric, 1000, Items.surgeAlloy, 1500));
            size = 9;
            plans.add(
                    new AssemblerUnitPlan(AUnitTypes.phoenix, 3600f, PayloadStack.list(UnitTypes.vela, 4, ABlocks.basicArmorModule, 7, ABlocks.basicSupportModule, 4)),
                    new AssemblerUnitPlan(AUnitTypes.sagittarius, 10800f, PayloadStack.list(UnitTypes.corvus, 6, ABlocks.calibratedArmorModule, 9, ABlocks.calibratedSupportModule, 6))
            );
            areaSize = 13;
            droneType = AUnitTypes.synthesisDrone;
        ...
        venomSynthesizer = new UnitAssembler("venom-synthesizer"){{
            requirements(Category.units, with(Items.lead, 3000, Items.titanium, 3000, Items.thorium, 1200, Items.silicon, 1200, Items.plastanium, 750, Items.phaseFabric, 1000, Items.surgeAlloy, 1500));
            size = 9;
            plans.add(
                    new AssemblerUnitPlan(AUnitTypes.scytarid, 3600f, PayloadStack.list(UnitTypes.arkyid, 4, ABlocks.basicArmorModule, 7, ABlocks.basicSpecialtyModule, 4)),
                    new AssemblerUnitPlan(AUnitTypes.mygalid, 10800f, PayloadStack.list(UnitTypes.toxopid, 6, ABlocks.calibratedArmorModule, 9, ABlocks.calibratedSpecialtyModule, 6))
            );
            areaSize = 13;
            droneType = AUnitTypes.synthesisDrone;
        ...
        mechanicalPayloadConveyor = new PayloadConveyor("mechanical-payload-conveyor"){{
            requirements(Category.units, with(AItems.aluminum, 1));
            size = 1;
            payloadLimit = 1;
            moveTime = 20f;
        }};
        ...
        mechanicalPayloadConveyorLarge = new PayloadConveyor("mechanical-payload-conveyor-large"){{
            requirements(Category.units, with(AItems.aluminum, 10, AItems.graphene, 5));
            size = 2;
            payloadLimit = 2;
            moveTime = 20f;
        }};
        ...
        mechanicalPayloadConveyor = new PayloadConveyor("mechanical-payload-conveyor-huge"){{
            requirements(Category.units, with(AItems.aluminum, 15, AItems.graphene, 10, AItems.steel, 5));
            size = 3;
            payloadLimit = 3;
            moveTime = 20f;
        }};
        ...
        mechanicalPayloadRouter = new PayloadRouter("mechanical-payload-router"){{
            requirements(Category.units, with(AItems.aluminum, 2));
            size = 1;
            payloadLimit = 1;
            moveTime = 20f;
        }};
        ...
        mechanicalPayloadRouterLarge = new PayloadRouter("mechanical-payload-router-large"){{
            requirements(Category.units, with(AItems.aluminum, 12, AItems.graphene, 10));
            size = 2;
            payloadLimit = 2;
            moveTime = 20f;
        }};
        ...
        mechanicalPayloadRouterHuge = new PayloadRouter("mechanical-payload-router-huge"){{
            requirements(Category.units, with(AItems.aluminum, 18, AItems.graphene, 15, AItems.steel, 8));
            size = 3;
            payloadLimit = 3;
            moveTime = 20f;
        }};
