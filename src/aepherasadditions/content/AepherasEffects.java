    ...
    public static void load(){
        irradiated = new StatusEffect("irradiated"){{
            ...
            affinity(StatusEffects.wet, (unit, result, time) -> {
                ...
                AepherasFx.irradiated.at(unit.x + Mathf.range(unit.bounds() / 2f), unit.y + Mathf.range(unit.bounds() / 2f));
